...
- `docs/runbook-omni-reverse.md` — reverse direction: read an S3 Iceberg lake from BigQuery (Omni), no copy into GCS
- `docs/daily-delta-pipeline-architecture.md` — worked solution: daily cross-cloud delta pipeline (AWS lake → GCP), with a decision log
